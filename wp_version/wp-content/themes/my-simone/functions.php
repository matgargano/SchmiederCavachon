...
function my_simone_scripts() {
	...
	wp_enqueue_style('my-simone-google-fonts', 'http://fonts.googleapis.com/css?family=Lato:400,100,400italic,700,900,900italic|PT+Serif:400,400italic,700italic,700');
